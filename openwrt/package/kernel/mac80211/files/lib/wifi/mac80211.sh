...
EOF
	...
	for _dev in /sys/class/ieee80211/*; do
		...
		# for 8072, /sys/class/ieee80211/phy2,phy3/devices link to the same dir
		# /sys/devices/platform/soc/c000000.wifi1, and this causes radio2 and radio3
		# in /etc/config/wireless can't be distinguished. Using mac address instead.
