                             ...
                             struct blob_attr *msg)
{
	...
	if (d != NULL) {
		...
		while (true) {
			...
			// Don't filter net device here, frontend will do it. Skip . and ..
			//if (0 == strncmp(e->d_name, "eth", 3) || 0 == strncmp(e->d_name, "wlan", 4) || 0 == strncmp(e->d_name, "br-lan", 6))
			if (!(0 == strncmp(e->d_name, ".", 1) || 0 == strncmp(e->d_name, "..", 2)))
