...
void* initTXOpParms(A_UINT8 *pParmsCommon, PARM_OFFSET_TBL *pParmsOffset, PARM_DICT *pParmDict)
{
    ...
    memset(pTXParms->pad2, 0, sizeof(pTXParms->pad2));
    ...
    fillParmOffsetTbl((A_UINT32)PARM_PAD2, (A_UINT32)(((A_UINT32)&(pTXParms->pad2)) - (A_UINT32)pTXParms), pParmsOffset);
