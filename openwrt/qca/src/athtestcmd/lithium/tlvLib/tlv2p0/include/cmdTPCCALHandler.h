...
typedef struct tpccal_parms {
    A_UINT8	radioId;
    A_UINT8	phyId;
    A_UINT8	TpcCalScheme;
    A_UINT8	AllChainsON;
    A_UINT16	NumTotalChains;
    A_UINT16	MultiChainMeasureMask;
...
typedef struct tpccalrsp_parms {
    ...
    A_UINT8	numFreq5G;
    A_UINT8	freq5G[WHAL_NUM_11A_CAL_PIERS_FTM];
    ...
    A_UINT8	phyId;
    A_UINT8	pad1;
    A_UINT16	mhz2G[FTM_MAX_NUM_FREQ_2G];
    A_UINT16	mhz5G[FTM_MAX_NUM_FREQ_5G];
