                       ...
                       A_UINT32 parmCode_tlv, A_UINT32 parmType_tlv, A_UINT32 parmSize_tlv, A_UINT8 **data, A_UINT32 *len)
{
	...
	//printf("DEBUG cmdparmsparse parmCode=%d, parmCode_tlv=%d, parmType_tlv=%d, parmModType=%d\n size=%d, parmSize_tlv=%d", parmCode, parmCode_tlv, parmType_tlv, parmModType, size, parmSize_tlv);
